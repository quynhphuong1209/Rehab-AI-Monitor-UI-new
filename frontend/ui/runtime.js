(function () {
  ...
  html[data-rehab-shell] [data-testid="stAppViewBlockContainer"] {
  ...
  #rehab-react-root {
    position:relative; z-index:5; width:calc(100vw - 24px);
    margin:calc(var(--rehab-content-top) + 4px) 12px 24px;
  ...
  html[data-rehab-drawer-open="true"] #rehab-react-root {
    width:calc(100vw - var(--rehab-drawer-w) - 24px);
    margin-left:calc(var(--rehab-drawer-w) + 12px);
    margin-right:12px;
  }
  ...
  .rehab-react-field input::placeholder,
  .rehab-react-field textarea::placeholder {
  ...
  .rehab-topbar {
    ...
    transition:left .2s ease, padding .2s ease, width .2s ease;
  }
  html[data-rehab-shell]:not([data-rehab-mode="auth"]) .rehab-topbar {
    padding-left:72px;
  }
  html[data-rehab-shell][data-rehab-drawer-open="true"]:not([data-rehab-mode="auth"]) .rehab-topbar {
    left:var(--rehab-drawer-w);
    width:calc(100vw - var(--rehab-drawer-w));
    padding-left:18px;
    grid-template-columns:minmax(180px, 260px) minmax(0, 1fr) minmax(260px, auto);
    gap:10px;
  }
  html[data-rehab-shell][data-rehab-drawer-open="true"]:not([data-rehab-mode="auth"]) .rehab-brand-mark {
    width:36px; height:36px; border-radius:11px;
  }
  html[data-rehab-shell][data-rehab-drawer-open="true"]:not([data-rehab-mode="auth"]) .rehab-brand-name {
    font-size:16px;
  }
  html[data-rehab-shell][data-rehab-drawer-open="true"]:not([data-rehab-mode="auth"]) .rehab-brand-sub {
    max-width:180px;
  }
  ...
  html[data-rehab-shell][data-rehab-drawer-open="true"]:not([data-rehab-mode="auth"]) .rehab-tabs {
    justify-content:flex-start;
    gap:5px;
  }
  html[data-rehab-shell][data-rehab-drawer-open="true"]:not([data-rehab-mode="auth"]) .rehab-tab {
    height:36px;
    padding:0 9px;
    gap:5px;
    font-size:12.4px;
  }
  html[data-rehab-shell][data-rehab-drawer-open="true"]:not([data-rehab-mode="auth"]) .rehab-tab .rehab-icon {
    width:14px; height:14px;
  }
  html[data-rehab-shell][data-rehab-drawer-open="true"]:not([data-rehab-mode="auth"]) .rehab-actions {
    max-width:360px;
    gap:6px;
  }
  html[data-rehab-shell][data-rehab-drawer-open="true"]:not([data-rehab-mode="auth"]) .rehab-rolebadge {
    padding:6px 9px;
    font-size:12px;
  }
  html[data-rehab-shell][data-rehab-drawer-open="true"]:not([data-rehab-mode="auth"]) .rehab-userchip {
    max-width:148px;
    flex:0 1 148px;
    gap:7px;
  }
  html[data-rehab-shell][data-rehab-drawer-open="true"]:not([data-rehab-mode="auth"]) .rehab-user-meta {
    max-width:96px;
  }
  .rehab-rolebadge {
  ...
  .rehab-drawer-fab {
    position:fixed; z-index:2147482705; left:14px; top:14px;
  ...
  .rehab-drawer-fab.is-open { left:14px; }
  .rehab-drawer-fab.is-hidden { display:none; }
  .rehab-drawer {
    position:fixed; z-index:2147482550; top:0; left:0; bottom:0; width:var(--rehab-drawer-w);
    ...
    transition:transform .2s ease; padding:84px 16px 28px; overflow-y:auto;
  ...
  html[data-rehab-shell] input::placeholder,
  html[data-rehab-shell] textarea::placeholder {
    color:var(--rehab-muted) !important;
    opacity:.58 !important;
    font-weight:500 !important;
  }
  html[data-rehab-shell] .main-footer,
  html[data-rehab-shell] .main-footer *,
  html[data-rehab-shell] .footer,
  html[data-rehab-shell] .footer *,
  html[data-rehab-shell] .project-footer,
  html[data-rehab-shell] .project-footer *,
  html[data-rehab-shell] .du-footer,
  html[data-rehab-shell] .du-footer *,
  html[data-rehab-shell] .contact-footer,
  html[data-rehab-shell] .contact-footer * {
    font-family:var(--rehab-ui) !important;
    letter-spacing:0 !important;
  }
  html[data-rehab-shell] .main-footer h1,
  html[data-rehab-shell] .main-footer h2,
  html[data-rehab-shell] .main-footer h3,
  html[data-rehab-shell] .footer h1,
  html[data-rehab-shell] .footer h2,
  html[data-rehab-shell] .footer h3,
  html[data-rehab-shell] .project-footer h1,
  html[data-rehab-shell] .project-footer h2,
  html[data-rehab-shell] .project-footer h3,
  html[data-rehab-shell] .du-footer h1,
  html[data-rehab-shell] .du-footer h2,
  html[data-rehab-shell] .du-footer h3 {
    font-family:var(--rehab-display) !important;
  }
  ...
  html[data-rehab-shell] .ncv-filter-note {
    display:inline-flex; align-items:center; min-height:26px; padding:0 10px; margin:0 0 10px;
    border-radius:999px; color:var(--rehab-blue-strong); background:rgba(37,110,217,.11);
    font:800 12px var(--rehab-ui);
  }
  html[data-rehab-shell] .ncv-select-panel,
  html[data-rehab-shell] .ncv-detail-panel,
  html[data-rehab-shell] .ncv-selected-video-card {
    background:var(--rehab-card); border:1px solid var(--rehab-line); border-radius:8px;
    box-shadow:var(--rehab-shadow-sm);
  }
  html[data-rehab-shell] .ncv-select-panel { padding:14px 16px 12px; margin:12px 0 14px; }
  html[data-rehab-shell] .ncv-selected-video-card {
    display:grid; grid-template-columns:auto minmax(180px,1.4fr) repeat(4,minmax(120px,1fr));
    gap:12px; align-items:center; padding:14px 16px; margin:12px 0;
  }
  html[data-rehab-shell] .ncv-selected-video-avatar {
    width:38px; height:38px; border-radius:50%; display:grid; place-items:center;
    background:var(--rehab-blue); color:#fff; font:900 12px var(--rehab-ui);
  }
  html[data-rehab-shell] .ncv-selected-video-card span,
  html[data-rehab-shell] .ncv-detail-grid span,
  html[data-rehab-shell] .ncv-detail-desc span { display:block; color:var(--rehab-muted); font:800 11.5px var(--rehab-ui); }
  html[data-rehab-shell] .ncv-selected-video-card b { display:block; color:var(--rehab-primary); font:800 13px/1.35 var(--rehab-ui); }
  html[data-rehab-shell] .ncv-selected-video-main span { overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
  html[data-rehab-shell] .ncv-detail-panel { padding:16px; margin:12px 0 18px; }
  html[data-rehab-shell] .ncv-detail-head {
    display:flex; align-items:center; justify-content:space-between; gap:12px; padding-bottom:12px;
    border-bottom:1px solid var(--rehab-line);
  }
  html[data-rehab-shell] .ncv-detail-head b { color:var(--rehab-primary); font:800 15px var(--rehab-ui); }
  html[data-rehab-shell] .ncv-detail-head span { color:var(--rehab-muted); font:800 12px var(--rehab-ui); }
  html[data-rehab-shell] .ncv-detail-grid { display:grid; grid-template-columns:repeat(3,minmax(0,1fr)); gap:12px; margin-top:14px; }
  html[data-rehab-shell] .ncv-detail-grid>div,
  html[data-rehab-shell] .ncv-detail-desc {
    padding:10px 12px; border:1px solid var(--rehab-line); border-radius:8px; background:var(--rehab-bg-soft);
  }
  html[data-rehab-shell] .ncv-detail-grid b { display:block; margin-top:4px; color:var(--rehab-primary); font:800 13px/1.35 var(--rehab-ui); }
  html[data-rehab-shell] .ncv-detail-desc { margin-top:12px; }
  html[data-rehab-shell] .ncv-detail-desc p { margin:5px 0 0; color:var(--rehab-secondary); font:500 13px/1.5 var(--rehab-ui); }
  ...
  @media (max-width: 900px) {
    ...
    .rehab-topbar { grid-template-columns:1fr auto; gap:10px; padding:10px 12px 10px 58px; }
    html[data-rehab-shell][data-rehab-drawer-open="true"]:not([data-rehab-mode="auth"]) .rehab-topbar {
      left:0;
      width:100vw;
      padding-left:58px;
    ...
    .rehab-drawer { top:0; width:var(--rehab-drawer-w); padding-top:124px; }
    .rehab-drawer-fab { top:13px; left:12px; }
    .rehab-drawer-fab.is-open { left:12px; }
    .rehab-backdrop { inset:0; }
    ...
    html[data-rehab-drawer-open="true"] #rehab-react-root {
      ...
      margin:calc(var(--rehab-content-top) + 4px) 14px 18px;
    }
    .rehab-react-grid,
    .rehab-react-panel {
    ...
    html[data-rehab-shell] .ncv-selected-video-card { grid-template-columns:auto 1fr; }
    html[data-rehab-shell] .ncv-detail-grid { grid-template-columns:1fr; }
  }
  @media (max-width: 520px) {
    ...
    .rehab-drawer { top:0; padding-top:124px; }
    .rehab-drawer-fab { top:13px; }
    .rehab-backdrop { inset:0; }
    html[data-rehab-shell] .rehab-js-content-anchor { height:0 !important; }
  }
  `;
  ...
  function ensureBase() {
    ...
    let fab = doc.getElementById("rehab-drawer-fab");
    if (fab) {
      const cleanFab = fab.cloneNode(true);
      fab.parentNode.replaceChild(cleanFab, fab);
      fab = cleanFab;
      fab.onclick = () => {
        const open = doc.documentElement.dataset.rehabDrawerOpen === "true";
        setDrawer(!open);
      };
    }
    let backdrop = doc.getElementById("rehab-backdrop");
    if (backdrop) {
      const cleanBackdrop = backdrop.cloneNode(true);
      backdrop.parentNode.replaceChild(cleanBackdrop, backdrop);
  ...
  function setDrawer(open) {
    const doc = parentDoc();
    const isAuth = doc.documentElement.dataset.rehabMode === "auth";
    state.drawerOpen = !!open && !isAuth;
    ...
    if (drawer) drawer.setAttribute("aria-hidden", state.drawerOpen ? "false" : "true");
    ...
    if (fab) {
      ...
      fab.setAttribute("aria-expanded", state.drawerOpen ? "true" : "false");
      fab.title = state.drawerOpen ? "Thu sidebar" : "Mở sidebar";
      fab.setAttribute("aria-label", state.drawerOpen ? "Thu sidebar" : "Mở sidebar");
    }
  }
  ...
  // Clean UTF-8 shell overrides. These replace older mojibake-rendered helpers
  // without disturbing the existing bridge and backend events.
  roleMeta = function(role) {
    const value = String(role || "");
    if (/quản|quan|admin/i.test(value)) return { kind:"admin", cls:"rb-qtv", icon:"i-cog", av:"QT", label:"Quản trị viên" };
    if (/nghiên|nghien|ncv/i.test(value)) return { kind:"researcher", cls:"rb-ncv", icon:"i-micro", av:"NC", label:"Nghiên cứu viên" };
    if (/bác|bac|ktv/i.test(value)) return { kind:"doctor", cls:"rb-doctor", icon:"i-stetho", av:"BS", label:"Bác sĩ / KTV PHCN" };
    return { kind:"patient", cls:"rb-patient", icon:"i-heart", av:"BN", label:"Bệnh nhân" };
  };

  setDrawer = function(open) {
    const doc = parentDoc();
    const isAuth = doc.documentElement.dataset.rehabMode === "auth";
    const nextOpen = !!open && !isAuth;
    state.drawerOpen = nextOpen;
    saveStorage({ drawerOpen: nextOpen });
    doc.documentElement.dataset.rehabDrawerOpen = nextOpen ? "true" : "false";
    const drawer = doc.getElementById("rehab-drawer");
    const backdrop = doc.getElementById("rehab-backdrop");
    const fab = doc.getElementById("rehab-drawer-fab");
    if (drawer) {
    ...
    if (fab) {
      ...
      fab.innerHTML = icon(nextOpen ? "i-close" : "i-menu");
      fab.setAttribute("aria-expanded", nextOpen ? "true" : "false");
      const label = nextOpen ? "Thu sidebar" : "Mở sidebar";
      fab.title = label;
      fab.setAttribute("aria-label", label);
      fab.onclick = () => {
        const currentOpen = doc.documentElement.dataset.rehabDrawerOpen === "true";
        setDrawer(!currentOpen);
      };
    }
  };

  renderAuthFallback = function(payload) {
    const doc = parentDoc();
    let root = doc.getElementById("rehab-auth-root");
    if (root && !root.classList.contains("rehab-auth-loading-root")) return;
    if (!root) {
  ...
  renderTopbar = function(payload) {
    ...
    topbar.querySelectorAll("[data-tab]").forEach((btn) => {
      btn.onclick = () => sendEvent({ type: "tab", tab: btn.getAttribute("data-tab") });
    });
    const logoutBtn = topbar.querySelector('[data-action="logout"]');
    if (logoutBtn) logoutBtn.onclick = () => sendEvent({ type: "logout" });
    const themeBtn = topbar.querySelector('[data-action="theme"]');
    if (themeBtn) {
      themeBtn.onclick = () => {
        const current = parentDoc().documentElement.dataset.rehabTheme || payload.theme || "light";
  ...
  roleHeader = function(sidebar, meta) {
    const profile = sidebar.profile || {};
    return `
      <div class="rehab-drawer-title">${icon(meta.icon)}VAI TRÒ</div>
      <div class="rehab-drawer-role">
  ...
  researcherSidebar = function(payload, sidebar, meta) {
    const profile = sidebar.profile || payload.user || {};
    const stats = sidebar.stats || payload.sideStats || {};
    const controls = sidebar.controls || {};
    const opts = sidebar.options || {};
    return `
      ...
      <div class="rehab-side-card">
        ...
        ${sideSelect("ncv_resize_width", "Độ phân giải video (Video Quality)", controls.ncv_resize_width ?? 480, opts.resize_width || [480,720,1080], {
          480:"480p (tốc độ tối ưu)", 720:"720p (HD - sắc nét)", 1080:"1080p (Full HD - chuẩn xác)"
        })}
        ${sideFieldRange("ncv_sensitivity", "Độ nhạy chuyển động (Sensitivity)", controls.ncv_sensitivity ?? 0.7)}
        ${sideSelect("ncv_giai_doan", "Giai đoạn tập bệnh nhân", controls.ncv_giai_doan || "Giai đoạn 2: Hồi phục (Sai số ±30°)", opts.phase_labels || [], null)}
      </div>
  ...
  doctorSidebar = function(payload, sidebar, meta) {
    const profile = sidebar.profile || payload.user || {};
    const stats = sidebar.stats || payload.sideStats || {};
    return `
      ${roleHeader(sidebar, meta)}
  ...
  patientSidebar = function(payload, sidebar, meta) {
    const profile = sidebar.profile || payload.user || {};
    return `
      ${roleHeader(sidebar, meta)}
      <div class="rehab-side-card">
      ...
      <div class="rehab-side-card">
        ...
        <div class="rehab-side-guide">
          <div class="rehab-side-guide-item"><b>${icon("i-shield")}Trang chủ</b><span>Khai báo thông tin, triệu chứng, chọn bài tập và tải video tập luyện lên cho bác sĩ.</span></div>
          <div class="rehab-side-guide-item"><b>${icon("i-bars")}Kết quả đánh giá</b><span>Xem nhận xét của bác sĩ/KTV và kết quả phân tích AI về chuyển động của bạn.</span></div>
          <div class="rehab-side-guide-item"><b>${icon("i-bell")}Lịch nhắc nhở</b><span>Xem lịch tái khám và các nhắc nhở tập luyện hằng ngày.</span></div>
          <div class="rehab-side-guide-item"><b>${icon("i-doc")}Thông tin</b><span>Tìm hiểu về bài tập phục hồi chức năng vai và kiến thức y tế hữu ích.</span></div>
          <div class="rehab-side-guide-item"><b>${icon("i-mail")}Liên hệ</b><span>Thông tin liên hệ với bác sĩ/KTV khi cần hỗ trợ khẩn cấp.</span></div>
        </div>
        ${creditsHtml(sidebar)}
      </div>
  ...
  adminSidebar = function(payload, sidebar, meta) {
    const profile = sidebar.profile || payload.user || {};
    const search = sidebar.adminSearch || {};
    const result = search.result || null;
    const resultHtml = result ? (
  ...
  sidebarHtml = function(payload) {
    const meta = roleMeta(payload.role || (payload.user || {}).role);
    const sidebar = payload.sidebar || {};
    if (meta.kind === "researcher") return researcherSidebar(payload, sidebar, meta);
    if (meta.kind === "doctor") return doctorSidebar(payload, sidebar, meta);
    if (meta.kind === "admin") return adminSidebar(payload, sidebar, meta);
    return patientSidebar(payload, sidebar, meta);
  };

  renderRoleChrome = function(payload) {
    if ((payload.mode || "app") === "auth") {
      resetRoleShellForAuth();
      return;
    }
    removeAuthRoot();
    const role = roleMeta(payload.role || (payload.user || {}).role);
    const key = role.kind === "admin" ? "Admin" :
      role.kind === "doctor" ? "DoctorKtv" :
      role.kind === "researcher" ? "Researcher" : "Patient";
